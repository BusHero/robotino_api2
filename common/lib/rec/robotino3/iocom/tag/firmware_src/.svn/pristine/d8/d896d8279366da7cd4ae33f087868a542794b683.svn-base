...
extern void sendline_unbuffered(const char* str);
...
int main (void)
{
	...
	const unsigned int sX_counter_max = 10;
...
#define com_inactive_counter_max 3
	...
	charger_init();
	printf("Scanning chargers ");
	while(charger_state != CHARGER_STATE_NORMAL)
	{
