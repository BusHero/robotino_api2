...
QByteArray rec::dataexchange_lt::messages::RegisterChannel::encode( const QString& name )
{
	...
	//header************************
	//message id
	*(datap++) = rec::dataexchange_lt::messages::RegisterChannelId;
...
QString rec::dataexchange_lt::messages::RegisterChannel::decode( const QByteArray& data )
{
	//daten ohne header
