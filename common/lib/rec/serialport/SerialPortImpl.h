...
namespace rec
{
	namespace serialport
	{
		...
		public:
			...
			virtual void setDTR(){ throw SerialPortException("setDTR not implemented"); }
			virtual void clearDTR(){ throw SerialPortException("clearDTR not implemented"); }
			
			virtual void setLogCb(rec_SerialPort_logCb_t func) {}
		};
	}
}
