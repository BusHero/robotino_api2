...
//  - CAN2_SpecialFunktion(unsigned int distributorcode, int codenumber )
//  - CAN2_MsgFilter(DWORD FromID,DWORD ToID, int Type) 
//  - CAN2_ResetFilter(void) 
//  - CAN2_ResetClient(void) 
//	- SetUSB2DeviceNr(DWORD DevNum) 
//	- GetUSB2DeviceNr(DWORD *DevNum) 
...
//
#ifndef __PCAN2USBH__
#define __PCAN2USBH__
...
//  Possible Errors:  NOVXD
//
DWORD __stdcall CAN2_SpecialFunktion(unsigned int distributorcode, int codenumber );
...
//
DWORD __stdcall SetUSB2DeviceNr(DWORD DevNum);
...
//
DWORD __stdcall GetUSB2DeviceNr(DWORD* DevNum);
