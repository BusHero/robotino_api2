#ifndef _REC_ROBOTINO3_IOCOM_TAG_ResetLpc_H_
#define _REC_ROBOTINO3_IOCOM_TAG_ResetLpc_H_

#include "rec/robotino3/iocom/tag/ResetLpcFwd.h"
...
#endif //_REC_ROBOTINO3_IOCOM_TAG_ResetLpc_H_
