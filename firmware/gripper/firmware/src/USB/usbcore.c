...
static inline BOOL USB_ReqGetStatus (void) {
  U32 n, m;
...
static inline BOOL USB_ReqSetClrFeature (U32 sc) {
  U32 n, m;
...
static inline BOOL USB_ReqSetAddress (void) {
...
static inline BOOL USB_ReqGetDescriptor (void) {
  U8  *pD;
  U32 len, n;
...
static inline BOOL USB_ReqGetConfiguration (void) {
...
static inline BOOL USB_ReqSetConfiguration (void) {
...
static inline BOOL USB_ReqGetInterface (void) {
...
static inline BOOL USB_ReqSetInterface (void) {
  USB_COMMON_DESCRIPTOR *pD;
