...
/*PC -> LPC*/
#define REC_ROBOTINOARM_DynamixelCommand		 0
#define REC_ROBOTINOARM_SetAllPositions			 1
#define REC_ROBOTINOARM_GetDetectedServos		 2
#define REC_ROBOTINOARM_EnableAutoUpdate		 3
#define REC_ROBOTINOARM_ResetChannel			 4
#define REC_ROBOTINOARM_GetAllPositions			 5
#define REC_ROBOTINOARM_EnablePower				 6
#define REC_ROBOTINOARM_ToggleTorque			 7
#define REC_ROBOTINOARM_GetAllAxesLimits		 8
#define REC_ROBOTINOARM_ResetDevice				 9
#define REC_ROBOTINOARM_GetInfo					10
#define REC_ROBOTINOARM_NUMMESSAGES_PC2LPC		11

/*LPC -> PC*/
#define REC_ROBOTINOARM_StatusReceiveTimeout	1
#define REC_ROBOTINOARM_Status					2
#define REC_ROBOTINOARM_Error					3
#define REC_ROBOTINOARM_EnableMotors			4
#define REC_ROBOTINOARM_StorePosition			5
#define REC_ROBOTINOARM_AllServoPositions		6
#define REC_ROBOTINOARM_DetectedServos			7
#define REC_ROBOTINOARM_AllAxesLimits			8
#define REC_ROBOTINOARM_Info					9

#define REC_ROBOTINOARM_InvalidMessageLength	0
#define REC_ROBOTINOARM_InvalidMessageType		1
#define REC_ROBOTINOARM_UnsupportedChannel		2
#define REC_ROBOTINOARM_KeepAlive 0xFF

#define REC_ROBOTINOARM_RX64CHANNEL 0
#define REC_ROBOTINOARM_RX28CHANNEL 1
#define REC_ROBOTINOARM_RX10CHANNEL 2

static unsigned char rec_robotinoarm_lpcToPC_checksum( const char* message )
{
	unsigned char i;
...
static unsigned char rec_robotinoarm_isMessageCorrect( const char* message )
{
	unsigned char i;
...
namespace rec
{
	namespace robotinoarm
	{
		...
		namespace serial
		{
			typedef enum
			{
				RX64Channel = REC_ROBOTINOARM_RX64CHANNEL,
				RX28Channel = REC_ROBOTINOARM_RX28CHANNEL,
				RX10Channel = REC_ROBOTINOARM_RX10CHANNEL
			}
			Channel;
			...
			public:
				...
				static rec::robotinoarm::HardwareInfo decodeDetectedServos( const char* data );

				static QByteArray encodeAllServoPositions( const QVector<quint16>& positions, const QVector<quint16>& speeds );
				static rec::robotinoarm::HardwareInfo decodeAllServoPositions( const char* data );
				
				static rec::robotinoarm::HardwareInfo decodeStorePosition( const char* data );

				static QByteArray encodeAllAxesLimits( const QVector<quint16>& cwLimits, const QVector<quint16>& ccwLimits );
				static rec::robotinoarm::HardwareInfo decodeAllAxesLimits( const char* data );
