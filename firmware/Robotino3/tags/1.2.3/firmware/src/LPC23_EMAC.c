...
void init_ethernet (void) {
	...
	printf( "Put the DP83848C in reset mode\n\r" );
	/* Put the DP83848C in reset mode */
	write_PHY (PHY_REG_BMCR, 0x8000);

	printf( "Wait for hardware reset to end\n\r" );
	...
	if (((id1 << 16) | (id2 & 0xFFF0)) == DP83848C_ID) {
		printf ( "Configure the PHY device\n\r" );
		/* Configure the PHY device */
#if defined (_10MBIT_)
		/* Connect at 10MBit */
		printf ( "Connect at 10MBit\n\r" );
		...
		printf ( "Use autonegotiation about the link speed\n\r" );
