...
extern unsigned int MPU6000_readBuf( unsigned char slaveAddr, unsigned char reg, unsigned char* buffer, unsigned int length );
extern unsigned int MPU6000_writeBuf( unsigned char slaveAddr, unsigned char reg, const unsigned char* buffer, unsigned int length );
static int i2c_write( unsigned char slave_addr,
					  unsigned char reg_addr,
					  unsigned char length,
					  unsigned char const *data )
{
	return MPU6000_writeBuf( slave_addr, reg_addr, data, length );
}
...
static int i2c_read( unsigned char slave_addr,
					 ...
					 unsigned char *data )
{
	return MPU6000_readBuf( slave_addr, reg_addr, data, length );
}
