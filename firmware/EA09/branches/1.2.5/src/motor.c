...
unsigned char motor_kp[ numMotors ] = { 80, 80, 80, 80 };
unsigned char motor_kp_default[ numMotors ] = { 80, 80, 80, 80 };
unsigned char motor_ki[ numMotors ] = { 25, 25, 25, 25 };
unsigned char motor_ki_default[ numMotors ] = { 25, 25, 25, 25 };
unsigned char motor_kd[ numMotors ] = { 100, 100, 100, 100 };
unsigned char motor_kd_default[ numMotors ] = { 100, 100, 100, 100 };
...
void motor_pi_control( unsigned char motor )
{
	...
	float K = 0.1f * motor_kp[motor];
	float Ki = 0.01f * motor_ki[motor];

	float ss = motor_speed_setpoint[motor];
	float y = fpga_motor_velocity[ motor ];
	...
	motor_control_point[motor] = (short)u;
