...
int main(int argc, char *argv[])
{
	...
	std::cout << "Connectiong to " << information.device_or_ip_name() << std::endl;
	std::cout << "Baudrate " << information.baudrate_or_port_number() << std::endl;
	std::cout << "Connection type " << (Lidar::Serial == information.connection_type() ? "Serial" : "Ethernet") << std::endl;
